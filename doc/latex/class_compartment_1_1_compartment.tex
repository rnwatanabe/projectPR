...
\item {\bfseries neuron\-Kind}\-: string with the type of the motor unit. It can be {\itshape S} (slow), {\itshape F\-R} (fast and resistant), and {\itshape F\-F} (fast and fatigable). 
\end{DoxyItemize}
\end{DoxyItemize}
...
\item {\bfseries V\-\_\-m\-V}\-: membrane potential, in m\-V. 
\end{DoxyItemize}
\end{DoxyItemize}
...
Capacitance of the compartment, in n\-F. 
...
Leak conductance of the compartment, in M\-S. 
