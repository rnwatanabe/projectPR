...
All the 95753 synapses were built
...
\end{verbatim}\textbf{Output \#{}7}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} <matplotlib.text.Text at 0x7f46bee56350>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MuscleHillExample_files/MuscleHillExample_8_1.png}
        \end{center}
...
\end{verbatim}\textbf{Output \#{}8}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} <matplotlib.text.Text at 0x7f46bf0da490>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MuscleHillExample_files/MuscleHillExample_10_1.png}
        \end{center}
...
\end{verbatim}\textbf{Output \#{}9}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <matplotlib.text.Text at 0x7f46befd9f50>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MuscleHillExample_files/MuscleHillExample_12_1.png}
        \end{center}
...
\end{verbatim}\textbf{Output \#{}10}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} <matplotlib.text.Text at 0x7f46bedae3d0>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MuscleHillExample_files/MuscleHillExample_14_1.png}
        \end{center}
...
\end{verbatim}\textbf{Output \#{}11}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} <matplotlib.text.Text at 0x7f46bce32210>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MuscleHillExample_files/MuscleHillExample_16_1.png}
        \end{center}
