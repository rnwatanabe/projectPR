...
\makeatother
    ...
    \author{Julius C. F. Schulz}\title{MNPoolWithRenshawCells}
...
connects to approximately 30 \% of the motor units. Also, a pool of 350
Renshaw cells is present.
...
simulation is shown in Fig. \ref{fig:spikesDescRenshaw}.
...
\end{verbatim}\textbf{Output \#{}7}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} <matplotlib.text.Text at 0x7f5bca842790>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics[width=\textwidth]{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_8_1.pdf}
        \end{center}
...
\end{verbatim}\textbf{Output \#{}8}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} <matplotlib.text.Text at 0x7f5bb97868d0>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics[width=\textwidth]{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_10_1.pdf}
        \end{center}
        \caption{Spike times of all motoneurons along the 5000 ms of simulation.}
        \label{fig:spikesMNRenshaw}
    \end{figure}
    
    The spike times of the Renshaw cells along the 5000 ms of simulation is
shown in Fig. \ref{fig:spikesRenshawRenshaw}.
...
\end{verbatim}\textbf{Output \#{}9}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <matplotlib.text.Text at 0x7f5bbba05dd0>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics[width=\textwidth]{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_12_1.pdf}
        \end{center}
...
\end{verbatim}\textbf{Output \#{}10}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} <matplotlib.text.Text at 0x7f5bacda78d0>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics[width=\textwidth]{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_14_1.pdf}
        \end{center}
