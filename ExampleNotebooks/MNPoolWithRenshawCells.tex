...
All the 124633 synapses were built
...
\end{verbatim}\textbf{Output \#{}7}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} <matplotlib.text.Text at 0x7f8acffe98d0>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_6_1.pdf}
        \end{center}
        \caption{}
        \label{}
    \end{figure}
...
\end{verbatim}\textbf{Output \#{}8}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} <matplotlib.text.Text at 0x7f8ac7405e50>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_7_1.pdf}
        \end{center}
        \caption{}
        \label{}
    \end{figure}
...
\end{verbatim}\textbf{Output \#{}9}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <matplotlib.text.Text at 0x7f8acd423e50>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_8_1.pdf}
        \end{center}
        \caption{}
        \label{}
    \end{figure}
...
\end{verbatim}\textbf{Output \#{}10}
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} <matplotlib.text.Text at 0x7f8aba60ba50>
\end{Verbatim}
        
    \begin{figure}
        \begin{center}
        \includegraphics{MNPoolWithRenshawCells_files/MNPoolWithRenshawCells_9_1.pdf}
        \end{center}
        \caption{}
        \label{}
    \end{figure}
